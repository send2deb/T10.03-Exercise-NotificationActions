...
public class NotificationUtils {
    ...
    private static final int NOTIFICATION_DISMISS_PENDING_INTENT_ID = 123;
    private static final int NOTIFICATION_DONE_PENDING_INTENT_ID = 456;
    ...
    private static NotificationCompat.Action ignoreRemiderAction (Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                NOTIFICATION_DISMISS_PENDING_INTENT_ID,
                intent,
    ...
    private static NotificationCompat.Action drinkWaterAction (Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                NOTIFICATION_DONE_PENDING_INTENT_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
